...
public class UnsignedOutOfRange extends NotificationParameter {
    ...
    public UnsignedOutOfRange(final UnsignedInteger exceedingValue, final StatusFlags statusFlags,
