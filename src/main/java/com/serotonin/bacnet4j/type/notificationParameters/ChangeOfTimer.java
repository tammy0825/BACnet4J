...
public class ChangeOfTimer extends NotificationParameter {
    ...
    public ChangeOfTimer(final TimerState newState, final StatusFlags statusFlags, final DateTime updateTime,
